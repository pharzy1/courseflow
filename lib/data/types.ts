...
export type CatalogQuery={term:string;ids?:string[];search?:string;department?:string;openOnly?:boolean;level?:string;unitsMin?:number;unitsMax?:number;minimumMedian?:string;sortBy?:"default"|"median";limit?:number;offset?:number};
